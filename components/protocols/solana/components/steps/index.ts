import Account from '@solana/components/steps/Account'
...
import GetGreeting from '@solana/components/steps/GetGreeting'
import CallGreeting from '@solana/components/steps/CallGreeting'

export {
    Account, Balance, Connect, Transfer, Deploy, Fund, Greeter, GetGreeting, CallGreeting
}
